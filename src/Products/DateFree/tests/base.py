...
def setup_product():
    ...
    import Products.DateFree
    zcml.load_config('configure.zcml', Products.DateFree)
    ...
    ztc.installProduct('CompoundField')
    ztc.installProduct('DateFree')
...
setup_product()
ptc.setupPloneSite(products=['DateFree'])
